<script setup>
  ...
  const visiblePesquisar = ref(false);
  const visibleMensagem = ref(false);
  const visibleNotificacao = ref(false);
  const visibleDadosFake = ref(true);
...
<template>
    <!-- Wrapper Start -->
    <div v-if="logado" class="wrapper">
      <div class="iq-sidebar sidebar-default">
        <div class="iq-sidebar-logo d-flex align-items-center">
          <a href="../backend/index.html" class="header-logo">
            <!-- <img src="/images/logo.svg" alt="logo" /> -->
            <h5 class="logo-title light-logo">Central de escalas</h5>
          </a>
        ...
        <div class="data-scrollbar" data-scroll="1">
          <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
              <li class="active">
                <a @click="$router.push('/dashboard')" class="svg-icon">
                  <svg
                    class="svg-icon"
                    width="25"
                    height="25"
              ...
              <li class="">
                <a @click="$router.push('/calendario')" class="svg-icon">
                  <svg
                    class="svg-icon"
                    width="25"
                    height="25"
        ...
        <div class="iq-navbar-custom">
          <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            >
              ...
              <a href="../backend/index.html" class="header-logo">
                <h4 class="logo-title text-uppercase">Central de escalas</h4>
              </a>
            </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto navbar-list align-items-center">
                  ...
                  <li v-if="visiblePesquisar" class="nav-item nav-icon search-content">
                    <a
                      href="#"
                  ...
                  <li v-if="visibleMensagem" class="nav-item nav-icon nav-item-icon dropdown">
                    <a
                      href="#"
                  ...
                  <li v-if="visibleNotificacao" class="nav-item nav-icon nav-item-icon dropdown">
                    <a
                      href="#"
                      class="search-toggle dropdown-toggle"
                  ...
                  <li class="nav-item nav-icon dropdown caption-content">
                    ...
                    >
                      <img
                        src="/images/user/igo.jpg"
                        class="img-fluid rounded-circle"
                        alt="user"
                      />
                      <div class="caption ml-3">
                        <h6 class="mb-0 line-height">
                          Rodrigo<i class="las la-angle-down ml-2"></i>
                        </h6>
                      </div>
                    </a>
                    <ul
                    ...
                    >
                      <li class="dropdown-item d-flex svg-icon">
                        ...
                        <a href="../app/user-profile.html">Meu perfil</a>
                      </li>
                      <li class="dropdown-item d-flex svg-icon">
                        <svg
                          class="svg-icon mr-0 text-primary"
      ...
      <div class="content-page" v-if="visibleDadosFake">
                        ...
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-sm-4 text-sm-right mt-3 mt-sm-0">
                              ...
                              <a
                                class="btn btn-white text-primary link-shadow mt-2"
                                >High</a
                              >
                            </div>
                          </div>
                    ...
                    <li class="col-lg-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="mb-3">
                            <i class="las la-calendar-check mr-2"></i>02 / 02 /
                            2021
                          </p>
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          >
                            ...
                            <div>
                              <a href="#" class="btn bg-warning-light"
                                >Development</a
                              >
                            </div>
                          </div>
              ...
              <div class="col-lg-12">
                <div class="form-group mb-0">
                  ...
                  <div class="custom-file">
                    ...
                    />
                    <label class="custom-file-label" for="inputGroupFile003"
                      >Upload media</label
                    >
                  </div>
                </div>
    ...
    <footer class="iq-footer" v-if="visibleFooter">      
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <ul class="list-inline mb-0">
              <li class="list-inline-item">
                <a @click="$router.push('/privacidade')">Política de privacidade</a>
              </li>
              <li class="list-inline-item">
                <a @click="$router.push('/termouso')">Termos de uso</a>
              </li>
            </ul>
          </div>
          <div class="col-lg-6 text-right">
            <span class="mr-1"
              ...
              ©</span
            >
            <a href="https://www.informatize.inf.br" target="_blank" class="">Informatize</a>.
          </div>
        </div>
      </div>
    </footer>  
