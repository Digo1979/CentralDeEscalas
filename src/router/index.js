...
const routes = [
  ...
  { path: '/configuracao', component: Configuracao, meta: { requiresAuth: true } },
  { path: '/privacidade', component: Privacidade, meta: { requiresAuth: false } },
  { path: '/termouso', component: TermoUso, meta: { requiresAuth: false } }  
]
