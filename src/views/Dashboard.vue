                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-4 text-sm-right mt-3 mt-sm-0">
                        ...
                        <a class="btn btn-white text-primary link-shadow mt-2"
                          >High</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-4 text-sm-right mt-3 mt-sm-0">
                        ...
                        <a class="btn btn-white text-secondary link-shadow mt-2"
                          >Medium</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-4 text-sm-right mt-3 mt-sm-0">
                        ...
                        <a class="btn btn-white text-warning link-shadow mt-2"
                          >Low</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-4 text-sm-right mt-3 mt-sm-0">
                        ...
                        <a class="btn btn-white text-success link-shadow mt-2"
                          >High</a
                        >
                      </div>
                    </div>
