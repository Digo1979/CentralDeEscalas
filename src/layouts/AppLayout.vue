...
// // Observa mudanças na variável `username`
// watch(username, (newValue, oldValue) => {
//   console.log(`Username mudou de ${oldValue} para ${newValue}`);
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6">
          <ul class="list-inline mb-0">
            <li class="list-inline-item">
              <a @click="$router.push('/privacidade')"
        ...
        <div class="col-lg-6 text-right">
          <span class="mr-1">{{ ano }} ©</span>
          <a href="https://www.informatize.inf.br" target="_blank" class=""
            >Informatize</a
          >.
        </div>
      </div>
